...
void main()
{
    ...
    float v27 = clamp(v22, 0.0, 1.0);
    vec3 v28 = (CB0[10].xyz * v27) + (CB0[12].xyz * clamp(-v22, 0.0, 1.0));
    vec4 v29 = vec4(v28.x, v28.y, v28.z, vec4(0.0).w);
    v29.w = (v27 * CB0[23].w) * (COLOR1.y * exp2((v26 * dot(v20, normalize(v21 + normalize(v23)))) - v26));
    gl_Position = v24;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = COLOR0;
