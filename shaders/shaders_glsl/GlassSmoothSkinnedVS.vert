...
void main()
{
    ...
    float v29 = (clamp(2.0 - (dot(v20, normalize(v26.xyz)) * 3.0), 0.0, 1.0) * 0.300000011920928955078125) * clamp(v27, 0.0, 1.0);
    vec4 v30 = COLOR0;
    v30.w = mix(v28, 1.0, v29);
    vec4 v31 = vec4(dot(CB0[20], v24), dot(CB0[21], v24), dot(CB0[22], v24), 0.0);
    ...
    vec3 v34 = (CB0[10].xyz * v33) + (CB0[12].xyz * clamp(-v22, 0.0, 1.0));
    vec4 v35 = vec4(v34.x, v34.y, v34.z, vec4(0.0).w);
    v35.w = (v33 * CB0[23].w) * (COLOR1.y * exp2((v32 * dot(v20, normalize(v21 + normalize(v23)))) - v32));
    gl_Position = v25;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = v30;
